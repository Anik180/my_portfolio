    ...
    <!-- datatable -->
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Education</h3>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$row->location}}</td>
                  <td><a href="{{route('edit.education',$row->id)}}" class="btn btn-info"><i class="far fa-edit"></i></a>
                  <a href="{{route('delete.education',$row->id)}}" class="btn btn-danger" id="delete"><i class="fas fa-trash-alt"></i></a> 
                  </td>
                </tr>
               @endforeach
                </tbody>
                  ...
                  <div class="form-group">
                    <label >Year</label>
                      @error('year')
                        ...
                        @enderror
                    <input type="text" name="year" class="form-control @error('category_en') is-invalid @enderror"  value="{{ old('year') }}" required id="Year" placeholder="Enter Year">
                  </div>
                  <div class="form-group">
                    <label >Degree</label>
                      @error('degree')
